...
services_data = {
    ...
    'automation': {
        ...
        'long_description': 'Transform your business operations with intelligent automation solutions that streamline workflows, reduce costs, and enhance productivity through advanced technologies.',
        'features': [
            {
                'icon': 'fa-solid fa-robot',
    ...
    'research': {
        ...
        'long_description': 'Drive innovation through comprehensive research and development support in emerging technologies, helping organizations stay ahead in the digital age.',
        'features': [
            {
                'icon': 'fa-solid fa-brain',
                'title': 'AI Research',
    ...
    'career': {
        ...
        'long_description': 'Empower your career journey with personalized coaching, mentorship, and professional development services tailored to the technology sector.',
        'features': [
            {
    ...
    'global_talent': {
        ...
        'long_description': 'Navigate global career opportunities with comprehensive support for international talent mobility, including visa guidance and relocation assistance.',
        'features': [
            {
